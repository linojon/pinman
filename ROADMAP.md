...
What we're planning to build next in **Pinman 2**. This is direction, not a schedule —
there are no dates, and priorities shift as beta feedback comes in.

Found a bug or have a request? [Open an issue](../../issues/new/choose).
